        ...
        public bool Playing
        {
            ...
            private set
            {
                ...
                if (playing)
                {
                    ...
                    play.Border = Properties.Resources.pause;
                    next.Border = Properties.Resources.stop;
                    timer1.Start();
                }
                else
                {
                    previus.Enabled = true;
                    play.Border = Properties.Resources.play;
                    next.Border = Properties.Resources.Right;
                }
